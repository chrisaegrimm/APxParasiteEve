...
def set_all_entrance_rules(world: PE1World) -> None:
    ...
    set_rule(manhattan_to_ch_norq, lambda state: state.has("Carnegie Hall Parking Pass", world.player))
    set_rule(manhattan_to_pd_norq, lambda state: state.has("N.Y.P.D. #17 Parking Pass", world.player))
    set_rule(manhattan_to_cp_norq, lambda state: state.has("Central Park Parking Pass", world.player))
    set_rule(manhattan_to_sh_norq, lambda state: state.has("Soho Parking Pass", world.player))
    set_rule(manhattan_to_hs_norq, lambda state: state.has("Hospital Parking Pass", world.player))
    set_rule(manhattan_to_ct_norq_or_cmbt_gk, lambda state: state.has("Chinatown Parking Pass", world.player))
    set_rule(manhattan_to_sw_cmbt_pk_or_gk, lambda state: state.has_all(("Subway Parking Pass", "Gate Key"), world.player))
    set_rule(manhattan_to_wh_norq, lambda state: state.has("Warehouse Parking Pass", world.player))
    set_rule(manhattan_to_mu_norq, lambda state: state.has("Museum Parking Pass", world.player))
    set_rule(manhattan_to_cb_k1, lambda state: state.has_all(("Chrysler BLDG. Parking Pass", "Chrysler Key 1"), world.player))
    ...
    set_rule(ct_cmbt_or_gk_to_sw_cmbt_pk_or_gk, lambda state: state.has_all(("Chinatown Parking Pass", "Subway Parking Pass"), world.player))
